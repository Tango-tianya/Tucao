...
object ApiConfig {
    ...
    const val BASE_RAW_API_URL = "https://www.tucao.one/"
    const val BASE_JSON_API_URL = "https://www.tucao.one/api_v2/"
    const val BASE_XML_API_URL = "https://www.tucao.one/"
    ...
    const val REPLY_API_URL = "https://www.tucao.one/index.php?m=comment&c=index&a=ajax"
     ...
     * XML
     */
    const val PLAY_URL_API_URL = "https://api.tucao.one/api/playurl"
    const val DANMU_API_URL = "https://www.tucao.one/index.php?m=mukio&c=index&a=init"
